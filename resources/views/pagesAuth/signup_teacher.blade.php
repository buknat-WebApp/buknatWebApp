                                ...
                                @endif
                                    <form method="POST" action="{{ route('signup_teacher') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control @if ($errors->has('office_or_department')) is-invalid @endif" aria-label="office_or_department" name="office_or_department"
                                                       id="office_or_department" placeholder="Grade Level Teacher" value="{{ old('office_or_department') }}">
                                                @if('office_or_department')
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('office_or_department') }}
                                                </div>
                                                @endif
                                            </div>
