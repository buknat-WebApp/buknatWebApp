                                                    ...
                                                    @if ($student['transactions']->isNotEmpty())
                                                        <tr>
                                                            <td class="align-middle text-center">
                                                                <a target="_blank" href="{{ Storage::url('IDPic/' . $student->id_pic) }}">
                                                                    <img src="{{ Storage::url('IDPic/' . $student->id_pic) }}" alt="Image" width="100px" height="100px">
                                                                </a>
                                                                <input type="text" id="id_pic" name="id_pic" value="{{ $student->id_pic }}" hidden>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div class="d-flex flex-column justify-content-center">
                                                                        <h6 id="id_number" class="mb-0 text-sm">{{ $student->id_number }}</h6>
