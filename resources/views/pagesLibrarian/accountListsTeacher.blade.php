                                                    ...
                                                    @foreach ($teachers as $teacher)
                                                        <tr>
                                                            <td class="align-middle text-center">
                                                                ...
                                                                <a target="_blank" class="avatar avatar-xl position-relative"
                                                                   href="{{ Storage::url('avatar/' . $teacher->avatar) }}">
                                                                    @if($teacher->avatar)
                                                                        <img src="{{ Storage::url('avatar/' . $teacher->avatar) }}"
                                                            ...
                                                            <td class="align-middle text-center">
                                                                @if($teacher->id_pic)
                                                                    <a target="_blank" class="avatar avatar-xl position-relative"
                                                                        href="{{ Storage::url('IDPic/' . $teacher->id_pic) }}">
                                                                        <img src="{{ Storage::url('IDPic/' . $teacher->id_pic) }}"
                                                                            alt="Image" class="w-75 h-75 border-radius-lg shadow-sm object-fit-cover border rounded">
                                                                    </a>
                                                                    <input type="text" id="id_pic" name="id_pic"
                                                                        value="{{ $teacher->id_pic }}" hidden>
                                                                @endif
                                                            </td>
                                                            <td>
