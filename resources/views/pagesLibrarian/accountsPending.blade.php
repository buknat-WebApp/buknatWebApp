                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="">
                                                                ...
                                                                <a type="button" class="btn btn-success btn-sm"
                                                                    ...
                                                                    data-sectioned="{{ $student->section }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('confirmAccount') }}">
                        ...
                        <label for="sectioned">Section:</label>
                        <input type="text" name="section" class="form-control" id="sectioned" required>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.approveStudent = function(that) {
                ...
                var sectioned = that.getAttribute('data-sectioned');
                ...
                document.getElementById('sectioned').value = sectioned || '';
