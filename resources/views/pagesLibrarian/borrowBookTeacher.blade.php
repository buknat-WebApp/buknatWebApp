                            ...
                            <div class="dropdown nav-item">
                                <button class="btn dropdown-toggle nav-link" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li><a class="dropdown-item" href="{{ route('borrowingForm') }}">Student</a></li>  
                                    </ul>
                            </div>
                            <li class="nav-item">
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            function updateCheckedCount() {
                                const checkedBooks = document.querySelectorAll('input[name="books[]"]:checked').length;
                                console.log('Checked books count:', checkedBooks); // Debugging line
                                return checkedBooks;
                            }

                            function handleCheckboxChange(event) {
                                const checkedBooks = updateCheckedCount();
                                if (checkedBooks > maxBooks) {
                                    alert('You can only select up to ' + maxBooks + ' books.');
